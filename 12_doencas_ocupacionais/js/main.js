;(function () {
	...
	var clickMenu = function() {
		...
		$('.navega a:not([class="external"])').click(function(event){
		    ...
		    if ( navega.is(':visible')) {
		    	navega.removeClass('in');
		    	navega.attr('aria-expanded', 'false');
		...
		$('.navega3 a:not([class="external"])').click(function(event){
			var section = $(this).data('nav-section');
			var	navega3 = $('.navega3');
		    ...
		    if ( navega3.is(':visible')) {
		    	navega3.removeClass('in');
		    	navega3.attr('aria-expanded', 'false');
		    	$('.js-fh5co-nav-toggle').removeClass('active');
		    }
	...
	var windowScroll = function() {
		...
		$(window).scroll(function(event){
			...
			if ( scrlTop > 500 && scrlTop <= 30000 ) {
				header.addClass('navbar-fixed-top fh5co-animated slideInDown');
				$('header').removeClass('some');
				
			} else if ( scrlTop <= 500) {
				$('header').addClass('some');
			} 
